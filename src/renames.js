...
type_mapping.set('jsx_text', 'JSXText')
type_mapping.set('jsx_opening_element', 'JSXOpeningElement')
type_mapping.set('jsx_self_closing_element', 'JSXElement')
type_mapping.set('jsx_closing_element', 'JSXClosingElement')
type_mapping.set('jsx_element', 'JSXElement')
type_mapping.set('class_static_block', 'StaticBlock')
